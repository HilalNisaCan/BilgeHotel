...
{  /// <summary>
   ...
   /// </summary>
    public class RoomImageManager : BaseManager<RoomImageDto, RoomImage>, IRoomImageManager
    {
        ...
        {
            var entity = _mapper.Map<RoomImage>(dto);
        ...
        {
            var list = await _roomImageRepository.GetAllAsync(x => x.RoomId == roomId);
        ...
        {
            var entity = await _roomImageRepository.GetByIdAsync(id);
