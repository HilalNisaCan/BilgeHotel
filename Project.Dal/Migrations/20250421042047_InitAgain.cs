        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasOvertime = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasAirConditioning = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    HasTV = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    HasHairDryer = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    HasWirelessInternet = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackupStatus = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingDetails = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    IsIdentityVerified = table.Column<bool>(type: "bit", nullable: false),
                    NeedsIdentityCheck = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourlyWage = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    MonthlySalary = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ShiftStart = table.Column<TimeSpan>(type: "time", nullable: false),
                    ShiftEnd = table.Column<TimeSpan>(type: "time", nullable: false),
                    WeeklyOffDay = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HasOvertime = table.Column<bool>(type: "bit", nullable: false),
                    WeeklyWorkedHours = table.Column<int>(type: "int", nullable: false),
                    TotalWorkedHours = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ComplaintLogs_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GuestNationality = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    BirthDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EntryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExitDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    GuestVisitStatus = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestVisitLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuestVisitLogs_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GuestVisitLogs_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogMessage = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ...
                    XmlFilePath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportLogs_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShiftStatus = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeShiftAssignments_EmployeeShifts_EmployeeShiftId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomCleaningSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomCleaningSchedules_Employees_AssignedEmployeeId",
                        column: x => x.AssignedEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_RoomCleaningSchedules_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "RoomMaintenanceAssignments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomMaintenanceAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomMaintenanceAssignments_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomMaintenanceAssignments_RoomMaintenances_RoomMaintenanceId",
                        column: x => x.RoomMaintenanceId,
                        principalTable: "RoomMaintenances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomMaintenanceAssignments_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EarlyReservationDiscounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EarlyReservationDiscounts_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_EarlyReservationDiscounts_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EarlyReservationDiscounts_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExtraExpenses_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExtraExpenses_Payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "Payments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExtraExpenses_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExtraExpenses_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplaintLogs_CustomerId",
                table: "ComplaintLogs",
                column: "CustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EarlyReservationDiscounts_CampaignId",
                table: "EarlyReservationDiscounts",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_EarlyReservationDiscounts_CustomerId",
                table: "EarlyReservationDiscounts",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_EarlyReservationDiscounts_ReservationId",
                table: "EarlyReservationDiscounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeShiftAssignments_EmployeeShiftId",
                table: "EmployeeShiftAssignments",
                column: "EmployeeShiftId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtraExpenses_CustomerId",
                table: "ExtraExpenses",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtraExpenses_PaymentId",
                table: "ExtraExpenses",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtraExpenses_ProductId",
                table: "ExtraExpenses",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtraExpenses_ReservationId",
                table: "ExtraExpenses",
                column: "ReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_GuestVisitLogs_CustomerId",
                table: "GuestVisitLogs",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_GuestVisitLogs_RoomId",
                table: "GuestVisitLogs",
                column: "RoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomCleaningSchedules_AssignedEmployeeId",
                table: "RoomCleaningSchedules",
                column: "AssignedEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomCleaningSchedules_RoomId",
                table: "RoomCleaningSchedules",
                column: "RoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomMaintenanceAssignments_EmployeeId",
                table: "RoomMaintenanceAssignments",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomMaintenanceAssignments_RoomId",
                table: "RoomMaintenanceAssignments",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomMaintenanceAssignments_RoomMaintenanceId",
                table: "RoomMaintenanceAssignments",
                column: "RoomMaintenanceId");
